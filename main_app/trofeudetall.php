...
if($varsesio == null || $varsesio = ''){
    ...
    die();
        ...
        require 'conn.php';
        $idtrofeu = $_POST['idtrofeu'];
        $sql = "SELECT t.Nom, a.Data, t.img, t.Descripcio, t.Punts, t.Exercicis from trofeu t INNER JOIN alumne_trofeu a ON t.ID = a.IDtrofeu where t.ID = $idtrofeu and a.IDalumne ='".$_SESSION['idalumne']."'";
        $result = $mysqli->query($sql);
        if ($result->num_rows > 0) {
            while($row = $result->fetch_assoc()) {
                $data = $row["Data"];
                $nom = utf8_encode($row["Nom"]);
                $desc = utf8_encode($row["Descripcio"]);
                $punts = $row["Punts"];
        ...
        <div class="container"><img id="logo" src="../assets/img/logo.png"><a class="navbar-brand" href="perfil_alumne.php"><strong>El Racó d'estudi</strong></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="perfil_alumne.php"><img src="../imatges/icones/perfil.png" alt="Perfil" height="42" width="42"></a>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                  <a href="trofeus.php"><img src="../imatges/icones/torna.png" alt="Perfil" height="42" width="42" href="perfil_alumne.php"></a>
        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" id="frmrg" method="POST" enctype="multipart/form-data" action="enunciat.php">
                ...
                <div class="form-row form-group">
                    <div class="col-sm-12 label-column">  <?php echo"<center><img id='img' width='230px' height='300px' src='../imatges/copes/".$img."'></center>"; ?>
                </div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-7 label-column">  <?php echo"<p style='color:black'>$desc</p> </br> <p><a style='color:black'>Data:</a> $data</p>"; ?>
                </div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-6 label-column">  <?php echo"<p><a style='color:black'>Exercicis:</a>$exercicis</p></br> <p><a style='color:black'>Punts:</a> $punts</p>"; ?>
                </div>
                </div>
