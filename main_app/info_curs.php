        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" id="frmrg" method="POST">
                ...
                <div class="form-row form-group">
                 ...
                 <button class="btn btn-primary" type="button" id="btcrea">CREA</button><a class="btn btn-danger form-btn" type="reset" href="gestionacurs.php">CANCEL·LA</a>
        </form>
        </div>
    </div>
</body>
<script type="text/javascript">
                    $('#btcrea').click(function(){
                        ...
                        var desc = $('#desc').val();
                         $.ajax({
                          type:"POST",
                           url:"modificacurs.php",
                           data: {nom: nom, categoria: categoria, desc: desc},
                           success:function(r){
                            if(r==1){                   
