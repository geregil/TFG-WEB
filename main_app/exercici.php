    ...
    <div class="row register-form">
        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" id="frmrg" method="POST">
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Punts</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" id="punts" name="punts"></div>
                </div>
