    ...
    <div class="row register-form">
        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" id="frmrg" method="POST">
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field" id="puntslabel">Punts</label></div>
                    <div class="col-sm-6 input-column"><input class="form-control" id="punts" name="punts" required /></div>
                </div>
                 <button class="btn btn-primary" type="button" id="btcrea">CREA</button><a class="btn btn-danger form-btn" type="reset" href="gestiona_exercici.php">CANCEL·LA</a>
        </form>
        </div>
    </div>
</body>
<script type="text/javascript">
                    $('#btcrea').click(function(){
                        ...
                        }else if((punts == null) || (punts == '')){
                            $("#puntslabel").css("color", "red");
                            $("#punts").css("background-color", "red");
                        }else{
                        	 $.ajax({
                          type:"POST",
                           url:"modificaexercici.php",
                           data: {nom: nom, punts: punts, intents: intents},
                           success:function(r){
                            if(r==1){                   
