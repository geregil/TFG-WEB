...
<body>
    ...
    <div class="row register-form">
        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" id="frmrg" method="POST" enctype="multipart/form-data" action="">
                <h1><?php echo $nom ?></h1>
               ...
               <div class="form-row form-group">
                    ...
                    <hr>
                    <center><p><?php echo $resposta ?></p></center></div>
              </div>
                <a class="btn btn-danger form-btn" type="reset" href="gestiona_exercici.php">TORNA</a>  </div>
         </div>
