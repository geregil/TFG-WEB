...
if($varsesio == null || $varsesio = ''){
    ...
    if(isset($_POST['text'])){
        ...
        $sql = "UPDATE EXERCICI SET Enunciat='$text', Resposta='$resposta', img='$image', auto='$resp' WHERE id=$id";
        ...
        <div class="container"><img id="logo" src="../assets/img/logo.png"><a class="navbar-brand" href="perfil_professor.php"><strong>El Racó d'estudi</strong></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="perfil_professor.php"><img src="../imatges/icones/perfil.png" alt="Perfil" height="42" width="42"></a>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                  <a href="gestiona_exercici.php"><img src="../imatges/icones/torna.png" alt="Perfil" height="42" width="42" href="perfil_alumne.php"></a>
        ...
        <div class="col-md-8 offset-md-2">
            <form class="custom-form" id="frmrg" method="POST" enctype="multipart/form-data" action="enunciat.php">
                ...
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Text</label></div>
                    <div class="col-sm-6 input-column"><textarea class="form-control" id="text" name="text" required /></textarea></div>
                </div>
                <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Imatge (opcional)</label></div>
                    <div class="col-sm-6 input-column"><input type="file" class="form-control" id="image" name="image"> </div>
              </div>
                 <div class="form-row form-group">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="email-input-field">Resposta automàtica</label></div>
                    <div class="col-sm-6 input-column">
                        <select class="form-control" id="resp" name="resp">
                           <option id="optsi" value="Sí">Sí</option>
                           <option id="optno" value="No">No</option>
                        </select>
                    </div>
                </div>
                <div class="form-row form-group" id="respo">
                    <div class="col-sm-4 label-column"><label class="col-form-label" for="name-input-field">Resposta</label></div>
                    <div class="col-sm-6 input-column"><textarea class="form-control" id="resposta" name="resposta" required /></textarea></div>
                </div>
                <input class="btn btn-primary" type="submit" id="btcrea" value="Crea"><a class="btn btn-danger form-btn" type="reset" href="gestiona_exercici.php">CANCEL·LA</a>  </div>
         </div>
