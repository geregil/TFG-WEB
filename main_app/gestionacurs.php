...
<body>
        ...
        <div class="container"><img id="logo" src="../assets/img/logo.png"><a class="navbar-brand" href="perfil_professor.php"><strong>El Racó d'estudi</strong></a><button data-toggle="collapse" class="navbar-toggler" data-target="#navcol-1"><span class="sr-only">Toggle navigation</span><span class="navbar-toggler-icon"></span></button><a href="perfil_professor.php"><img src="../imatges/icones/perfil.png" alt="Perfil" height="42" width="42"></a>
            <div
                ...
                <ul class="nav navbar-nav ml-auto">
                  <a href="gestiona_cursos.php"><img src="../imatges/icones/torna.png" alt="Perfil" height="42" width="42" href="perfil_alumne.php"></a>
    ...
    <div class="dark-section">
        <div class="container site-section" id="why">
            <h1><strong>Curs: <?php echo $nom?></strong></h1></br>
             <h3> <?php echo $desc?></h3>
            <div class="row">
                <div class="col-md-3"><i class="fa fa-pencil-square-o"></i>
                    <h2>Modifica curs</h2><a class="btn btn-primary" type="button" href="info_curs.php">Entra</a></div>
                <div class="col-md-3"><i class="fa fa-user-circle-o"></i>
                    <h2>Alumnes</h2><a class="btn btn-primary" type="button" href="alumnes_curs.php">Entra</a></div>
                <div class="col-md-3"><i class="fa fa-bars"></i>
                    <h2>Tasques</h2><a class="btn btn-primary" type="button" href="gestiona_tasques.php">Entra</a></div>
                <div class="col-md-3"><i class="fa fa-folder-open"></i>
                    <h2>Biblioteca</h2><a class="btn btn-primary" type="button" href="gestiona_recursos.php">Entra</a></div>
            </div>
        </div>
    </div>
