...
<body>
    ...
    <div class="login-clean">
        <form method="post" id="formpg">
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="icon ion-ios-home" id="login-icon"></i></div>
            <div class="form-group"><input class="form-control" type="email" name="email" placeholder="Correu"></div>
            <div class="form-group"><input class="form-control" type="password" name="password" placeholder="Contrasenya"></div>
            <div class="form-group"><button class="btn btn-info btn-block" type="submit" id="botonlg">Accés</button></div><a class="forgot" href="recuperar_password.php">Problemes per entrar?</a></form>
